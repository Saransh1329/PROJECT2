...
try:
    ...
    if story_response.status_code == 200:
        story_analysis = story_response.json()["choices"][0]["message"]["content"]
        print("AI-driven story analysis retrieved successfully.")
    else:
        print("Error with AI-driven story analysis request:", story_response.status_code, story_response.text)
        sys.exit(1)

except httpx.TimeoutException:
    print("Request timed out during story analysis.")
    sys.exit(1)

# Step 8: Create a README.md to include the results, insights, and visualizations
...
with open("README.md", "w") as f:
    ...
    f.write("## AI-Driven Story Analysis\n")
    f.write("The following story-based insights were generated by AI, interpreting the key trends, patterns, and outliers from the visualizations:\n\n")
    f.write(story_analysis)
    f.write("\n\n")
